local function on_attach(bufnr)
  ...
  vim.keymap.set('n', 'gh', api.tree.collapse_all, opts('Collapse all'));
  vim.keymap.set('n', 'gl', api.tree.expand_all, opts('Expand all'));
...
require('nvim-tree').setup({
  ...
  renderer = {
    ...
    root_folder_label = function(path)
      if path:find("/Users/jinkyuhan/Developer/") then
        return path:gsub("/Users/jinkyuhan/Developer/", "")
      end
      return path
    end,
    indent_width = 2,
