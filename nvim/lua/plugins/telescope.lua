...
local function bookmarks()
  local opts = {
    ...
    --     local directories = vim.fn.systemlist('ls -l --color=auto ' .. entry.value);
    --     vim.api.nvim_buf_set_lines(self.state.bufnr, 0, -1, false, directories);
    --   end
    -- }),
...
vim.keymap.set('n', 'π', bookmarks, bufopts)
